...
const checkSchema = require('express-validation')
 ...
 */
router.route('/login').post(checkSchema(login.body), controller.login)
 ...
 */
router.route('/refresh-token').post(checkSchema(refresh.body), controller.refresh)
 ...
 */
router.route('/facebook').post(checkSchema(oAuth), oAuthLogin('facebook'), controller.oAuth)
 ...
 * @apiError (Unauthorized 401)  Unauthorized    Incorrect access_token
 */
router.route('/google').post(checkSchema(oAuth), oAuthLogin('google'), controller.oAuth)
